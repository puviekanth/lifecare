...
interface NavbarProps {
  ...
  onNavigateToVisitVerification?: () => void;
}
  ...
  const navigationItems = [
    ...
    { 
      ...
      dropdown: [
        ...
        { name: 'Prescription Verification', href: '#prescription-verification', onClick: onNavigateToPrescriptionVerification },
        { name: 'Visit Verification', href: '#visit-verification', onClick: onNavigateToVisitVerification }
      ]
    },
    { 
      name: 'Doctors', 
