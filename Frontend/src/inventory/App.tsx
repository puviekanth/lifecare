...
const services: Service[] = [
  {
    ...
    description:
      "Book appointments with specialist doctors across multiple medical fields",
    icon: Stethoscope,
    features: [
      "Online Booking",
...
const featuredDoctors: Doctor[] = [
  ...
  },
  {
    ...
    rating: 4.8,
    image:
      "https://images.pexels.com/photos/6749778/pexels-photo-6749778.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop",
...
const testimonials: Testimonial[] = [
  {
    ...
    role: "Patient",
    content:
      "LifeCare has transformed how I manage my family's healthcare. The online booking system is so convenient, and the doctors are exceptional.",
    rating: 5,
    image:
  ...
  },
  {
    ...
    content:
      "The telemedicine service saved me so much time. I can consult with my doctor from home and get prescriptions digitally.",
    rating: 5,
    image:
  ...
  },
  {
    ...
    content:
      "As a healthcare provider, LifeCare's platform has streamlined our patient management and improved care coordination significantly.",
    rating: 5,
    image:
      "https://images.pexels.com/photos/5327656/pexels-photo-5327656.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop",
  },
];
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Experience world-class healthcare with LifeCare's
                  comprehensive channeling services. Connect with top
                  specialists, manage your health records, and access care
                  anytime, anywhere.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              medical needs with convenience and excellence
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              We're committed to providing exceptional healthcare services with
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Round-the-clock access to healthcare services and support",
              },
              {
                icon: Award,
      ...
      <section id="services" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real stories from real patients who have experienced the LifeCare
              difference
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied patients who trust LifeCare for their
            healthcare needs
          </p>
      ...
      <footer id="contact" className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 LifeCare Channeling Services. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
